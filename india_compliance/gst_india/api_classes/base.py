    ...
    if is_scheduler_disabled():
        frappe.throw(
            _(
                ...
                "Please get in touch with AiBizzHub Support to resolve this issue.<br><br>"
                "For more information, refer to the following link: {0}"
            ).format(
                """
                <a href="https://support.aibizzhub.io" target="_blank">
                    AiBizzHub Support
                </a>
                """
            )
